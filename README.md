...
<p align="center">
  ...
  <br>
  <em>Figure 2. Table: leave-one-out cross-validation of hydrological signatures across Emilia-Romagna catchments (Northern Italy): FDC2Qt predictions in blue, observations in black. Scatterplots: accurancy of hourly streamflow predictions from GR5H and FDC2Qt, both derived from the same regional PORFDC.</em>
</p>
